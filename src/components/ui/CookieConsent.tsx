            ...
            <div className="max-w-2xl mx-auto pointer-events-auto">
                <div className="bg-white/95 backdrop-blur-xl border border-slate-200 rounded-2xl shadow-2xl p-5">
                    ...
                    <div className="flex items-start gap-3 mb-3">
                        <div className="w-9 h-9 rounded-xl bg-[rgba(20,184,166,0.10)] border border-[#14B8A6]/20 flex items-center justify-center shrink-0 mt-0.5">
                            <Cookie size={16} className="text-[#0F766E]" />
                        </div>
                        <div className="flex-1">
                            <h3 className="text-slate-900 font-bold text-sm">Usamos cookies 🍪</h3>
                            <p className="text-slate-500 text-xs mt-0.5 leading-relaxed">
                                Utilizamos cookies para mejorar tu experiencia, analizar el tráfico y personalizar el contenido.
                                Al continuar navegando, aceptas nuestra{' '}
                                <a href="/legal/privacy" className="text-[#0F766E] underline hover:no-underline">Política de Privacidad</a>{' '}
                                y nuestra{' '}
                                <a href="/legal/cookies" className="text-[#0F766E] underline hover:no-underline">Política de Cookies</a>.
                            </p>
                        </div>
                        <button onClick={() => accept(false)} className="text-slate-400 hover:text-slate-700 transition-colors shrink-0">
                            <X size={16} />
                        </button>
                    </div>
                    ...
                    <div className="flex gap-2 flex-col sm:flex-row">
                        <button
                            ...
                            className="flex-1 sm:flex-none px-4 py-2 text-xs text-slate-600 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-xl transition-colors"
                        >
                            Solo necesarias
                        </button>
                        <button
                            onClick={() => accept(true)}
                            className="flex-1 px-4 py-2 text-xs font-bold text-white bg-[#14B8A6] hover:bg-[#0F9488] rounded-xl shadow-[0_4px_14px_rgba(20,184,166,0.30)] hover:shadow-[0_6px_20px_rgba(20,184,166,0.45)] transition-all"
                        >
                            Aceptar todo
                        </button>
                    </div>
