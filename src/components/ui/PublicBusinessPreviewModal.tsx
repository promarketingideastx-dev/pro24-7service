...
export default function PublicBusinessPreviewModal({ isOpen, onClose, business }: PublicBusinessPreviewModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[3000] flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm sm:p-4 animate-in fade-in duration-200">
            ...
            <div className="relative bg-[#1e5555] w-full max-w-lg sm:rounded-3xl rounded-t-3xl border border-white/10 shadow-2xl overflow-hidden flex flex-col max-h-[90vh] sm:max-h-[85vh] animate-in slide-in-from-bottom duration-300">
                ...
                <div className="relative h-48 sm:h-56 shrink-0">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#1e5555] via-transparent to-transparent"></div>
