...
export default function WeeklyScheduleEditor({
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-[#1e5555] border border-white/10 w-full max-w-2xl rounded-2xl p-6 shadow-2xl relative max-h-[90vh] overflow-y-auto custom-scrollbar">
                <button
                    onClick={onClose}
                            ...
                            <div key={day} className={`flex items-center gap-4 p-3 rounded-xl border ${isEnabled ? 'bg-white/5 border-white/10' : 'bg-transparent border-transparent opacity-60'} transition-all`}>
                                ...
                                <div className="flex items-center gap-2 flex-1">
                                    <input
                                        ...
                                        className="bg-[#154040] border border-white/10 rounded px-2 py-1 text-white text-sm focus:border-brand-neon-cyan focus:outline-none disabled:opacity-30"
                                    />
