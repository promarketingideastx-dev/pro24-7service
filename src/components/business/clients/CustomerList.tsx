        ...
        <div className="space-y-4">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full bg-[#1e5555] border border-white/5 rounded-xl py-3 pl-10 pr-4 text-white placeholder:text-slate-500 focus:outline-none focus:border-white/10 focus:ring-1 focus:ring-white/10 transition-all"
                />
            </div>
            ...
            {customers.length > 0 && (
                <div className="grid grid-cols-3 gap-3">
                    <div className="bg-[#1e5555] border border-white/5 rounded-xl p-3 text-center">
            ...
            <div className="space-y-2">
                {filteredCustomers.length === 0 ? (
                    <div className="text-center py-12 text-slate-500 bg-[#1e5555]/50 rounded-xl border border-white/5 border-dashed">
                    ...
                    filteredCustomers.map((customer) => {
                        ...
                        return (
                            <div
                                key={customer.id}
                                className="group bg-[#1e5555] hover:bg-[#1a2138] border border-white/5 rounded-xl p-4 transition-all hover:shadow-lg hover:border-white/10 cursor-pointer"
                                    ...
                                    <div className="w-full md:col-span-3 flex items-center gap-3">
                                        <div className="relative shrink-0">
                                            ...
                                            {stats.appointmentCount > 0 && (
                                                <div className="absolute -bottom-1 -right-1 w-4 h-4 rounded-full bg-green-500 border-2 border-[#1e5555] flex items-center justify-center">
