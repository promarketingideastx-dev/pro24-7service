...
export default function AppointmentModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="bg-[#1e3a5f] border border-white/10 rounded-2xl w-full max-w-lg shadow-2xl relative flex flex-col max-h-[90vh]">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-6 overflow-y-auto custom-scrollbar space-y-4">
                    ...
                    <div className="space-y-1 relative">
                        ...
                        {showCustomerResults && customerSearch && filteredCustomers.length > 0 && !currentCustomerId && (
                            <div className="absolute z-10 w-full bg-[#1e3a5f] border border-white/10 rounded-xl shadow-xl mt-1 max-h-40 overflow-y-auto custom-scrollbar">
