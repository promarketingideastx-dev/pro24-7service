        ...
        <div className="p-4 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
            {services.map((service) => (
                <div
                    ...
                    className="group bg-[#1a1030] border border-white/5 rounded-2xl p-4 hover:border-brand-neon-cyan/30 hover:bg-white/5 transition-all cursor-pointer flex justify-between gap-4"
                >
