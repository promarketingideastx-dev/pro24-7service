...
export default function ReviewsTab({ business }: ReviewsTabProps) {
    ...
    return (
        <div className="p-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {/* Summary Card */}
            <div className="bg-[#1a1030] rounded-3xl p-8 border border-white/5 flex flex-col md:flex-row items-center justify-between gap-8 mb-8">
            ...
            <div className="space-y-4">
                {loading ? (
                    ...
                    reviews.map((review) => (
                        <div key={review.id} className="bg-[#1a1030] p-6 rounded-2xl border border-white/5 flex gap-4 transition-all hover:bg-white/5">
                            {/* Avatar */}
