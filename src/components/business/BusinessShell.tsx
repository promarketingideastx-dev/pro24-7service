    ...
    return (
        <BusinessGuard>
            <AppointmentRefreshProvider>
                <div className="min-h-screen bg-[#0f0d1a] text-white flex flex-col md:flex-row relative overflow-hidden">
                    ...
                    {/* Mobile Header */}
                    <div className="md:hidden flex items-center justify-between p-4 bg-[#1a1030]/90 backdrop-blur-md border-b border-white/10 z-50 sticky top-0">
                    ...
                    <aside className={`
                    fixed inset-y-0 left-0 z-40 w-64 bg-[#1a1030]/95 backdrop-blur-xl border-r border-white/10 transform transition-transform duration-300 ease-in-out
