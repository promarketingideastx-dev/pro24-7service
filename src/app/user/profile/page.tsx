...
export default function UserProfilePage() {
    ...
    if (!user) return <div className="min-h-screen bg-[#154040] text-white flex items-center justify-center">Cargando...</div>;

    return (
        <div className="min-h-screen bg-[#154040] text-white pb-20">
            {/* Header / Nav Back */}
            <div className="bg-[#1e5555] border-b border-white/5 px-6 py-4 flex items-center justify-between sticky top-0 z-50">
            ...
            <div className="max-w-3xl mx-auto px-6 py-10 space-y-8">
                ...
                {/* 1. Identity Section */}
                <div className="bg-[#1e5555] border border-white/5 rounded-3xl p-6 md:p-8">
                        ...
                        <div className="space-y-4 w-full">
                            <div className="space-y-1">
                                ...
                                <input
                                    ...
                                    className="w-full bg-[#154040] border border-white/10 rounded-xl px-4 py-3 focus:border-brand-neon-cyan/50 focus:outline-none transition-colors"
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-[#154040] border border-white/10 rounded-xl pl-10 pr-4 py-3 focus:border-brand-neon-cyan/50 focus:outline-none transition-colors"
            ...
            {showDeleteModal && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-[#1e5555] border border-red-500/20 w-full max-w-sm rounded-3xl p-6 shadow-2xl relative ring-1 ring-red-500/20">
