...
export default function BusinessProfilePage() {
    ...
    if (loading || pageLoading) {
        return <div className="min-h-screen bg-[#1a2f4e] flex items-center justify-center text-slate-400">Cargando perfil...</div>;
    }

    // 1. Error State
    if (error) {
        return (
            <div className="min-h-screen bg-[#1a2f4e] flex flex-col items-center justify-center text-white gap-4">
    ...
    if (!publicData) {
        return <div className="min-h-screen bg-[#1a2f4e] flex items-center justify-center text-white">Negocio no encontrado</div>;
    }
