...
export default function Home() {
    ...
    if (isCountryLoading) return <div className="h-screen bg-[#1a2f4e] flex items-center justify-center text-white">Cargando...</div>;
    if (!selectedCountry) return <CountrySelector />;

    return (
        <main className="h-screen bg-[#1a2f4e] text-white overflow-hidden font-sans flex flex-col">
            {/* Header with Dynamic Location */}
            <header className="shrink-0 px-6 py-4 flex justify-between items-center z-50 bg-[#1a2f4e]">
                ...
                <div className="flex items-center gap-3">
                    {user ? (
                        <div className="flex items-center gap-3 group relative">
                            ...
                            <div className="absolute top-12 right-0 w-48 bg-[#1e3a5f] border border-white/10 rounded-xl shadow-2xl p-2 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all z-50">
            ...
            <div className="flex-1 flex flex-col min-h-0">
                ...
                <div className="shrink-0 px-6 pb-4 z-40">
                    <div className="relative group">
                        ...
                        <div className="relative flex items-center bg-[#1e3a5f] border border-white/10 rounded-2xl px-5 py-3 shadow-2xl">
                ...
                <div className="shrink-0 mx-6 mb-4 rounded-3xl overflow-hidden border border-white/10 shadow-2xl group cursor-pointer isolate relative transition-all duration-300 h-[35vh] min-h-[250px] max-h-[400px] md:h-[400px]">
                    ...
                    <div className="absolute bottom-4 left-4 z-[1000] pointer-events-none">
                        <div className="bg-[#1a2f4e]/80 backdrop-blur px-3 py-1.5 rounded-lg border border-white/10 flex items-center gap-2">
                ...
                <div className="flex-1 overflow-y-auto px-6 pb-24 space-y-3 custom-scrollbar">
                    {filteredBusinesses.map((biz) => (
                        <div
                            ...
                            className={`flex items-center p-3 bg-[#1e3a5f] border rounded-2xl transition-all cursor-pointer group
                ...
                {selectedCategory && selectedTaxonomy && (
                    <div className="fixed inset-0 z-[2000] flex items-end sm:items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in duration-200">
                        <div className="bg-[#1e3a5f] w-full max-w-lg rounded-3xl border border-white/10 shadow-2xl overflow-hidden flex flex-col max-h-[85vh] animate-in slide-in-from-bottom duration-300">
