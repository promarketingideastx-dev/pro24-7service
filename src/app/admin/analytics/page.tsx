        ...
        <div className="space-y-4">
            ...
            <div className="flex items-center justify-between flex-wrap gap-3">
                <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">Vista de perfil → Cita confirmada</p>
                </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {[
                    { label: 'Visitas', value: topCount.toLocaleString(), icon: '👁️', color: 'text-blue-400' },
                    { label: 'Modales Abiertos', value: (steps[1]?.count ?? 0).toLocaleString(), icon: '📅', color: 'text-cyan-400' },
                    { label: 'Citas Confirmadas', value: bottomCount.toLocaleString(), icon: '✅', color: 'text-green-400' },
