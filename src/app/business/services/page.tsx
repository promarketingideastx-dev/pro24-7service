                    ...
                    {regularServices.length > 0 && (
                        <div>
                            <h2 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-3 flex items-center gap-2">
                                <Tag size={14} /> Servicios Principales
                    ...
                    {extraServices.length > 0 && (
                        <div>
                            <h2 className="text-sm font-semibold text-amber-400/80 uppercase tracking-wider mb-3 flex items-center gap-2">
                                <Zap size={14} className="text-amber-400" /> Servicios Extra
                        ...
                        <div className="flex items-center justify-between px-6 py-4 border-b border-white/5">
                            <div>
                                ...
                                <p className="text-xs text-slate-500 mt-0.5">
                                    Los servicios aparecerán al agendar citas
                                </p>
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-5 max-h-[80vh] overflow-y-auto">
                            ...
                            >
                                {isSubmitting ? (
                                    ...
                                    <><Check size={16} /> {editingId ? 'Guardar Cambios' : 'Crear Servicio'}</>
                                )}
                            </button>
                        </form>
                    </div>
                ...
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-[#0f1629] border border-white/10 w-full max-w-sm rounded-2xl p-6 shadow-2xl">
                        <div className="flex flex-col items-center text-center mb-6">
                            ...
                            <p className="text-slate-400 text-sm">Esta acción no se puede deshacer. El servicio dejará de estar disponible.</p>
                        </div>
