            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 space-y-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-[#154040] border border-white/10 rounded-lg px-4 py-2 text-white focus:border-brand-neon-cyan focus:outline-none"
                                />
                            </div>
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-[#154040] border border-white/10 rounded-lg px-4 py-2 text-white focus:border-brand-neon-cyan focus:outline-none h-24 resize-none"
                                />
                            </div>
                    ...
                    <GlassPanel className="p-6">
                        ...
                        <div className="flex items-center justify-between bg-[#154040] p-4 rounded-lg border border-white/5">
                            <div>
                                                ...
                                                className={`
                                                    ...
                                                    ${isPrimary
                                                        ...
                                                        : isAdditional
                                                            ...
                                                            : 'bg-[#154040] border-white/5 text-slate-400 hover:border-white/20'
                                                    }
                                                `}
                                            >
