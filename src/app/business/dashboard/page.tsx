    ...
    const kpiCards = [
        ...
        },
        {
            ...
            sub: revenueChange !== null
                ? `${revenueChange >= 0 ? '+' : ''}${revenueChange}% vs mes ant.`
                : 'Este mes',
                    ...
                    <GlassPanel className="p-5">
                        ...
                        {stats.weeklyRevenue.every(w => w.amount === 0) ? (
                            <div className="text-center py-8 text-slate-600 text-sm">
                                ...
                                <p className="text-xs mt-1 text-slate-700">Los ingresos se calculan de citas confirmadas/completadas con precio.</p>
                            </div>
                        ) : (
                ...
                <div className="space-y-5">
                    ...
                    <GlassPanel className="p-5">
                        <h3 className="text-sm font-bold text-white mb-4 flex items-center gap-2">
                            ...
                            <span className="text-xs text-slate-500 font-normal ml-auto">30 días</span>
                        </h3>
                        <div className="flex items-center gap-4">
                            ...
                            <div className="text-xs text-slate-400 leading-relaxed">
                                De tus citas recientes fueron <span className="text-green-400 font-medium">confirmadas o completadas</span>.
                            </div>
                        </div>
                    </GlassPanel>
                                    ...
                                    return (
                                        <div key={i}>
                                            <div className="flex items-center justify-between text-xs mb-1">
                                                ...
                                                <span className="text-slate-500 shrink-0">{svc.count} citas</span>
                                            </div>
                    ...
                    <GlassPanel className="p-5">
                        ...
                        <div className="space-y-2">
                            <a href="/business/clients" className="w-full p-3 bg-white/5 hover:bg-white/10 rounded-lg text-left text-sm text-slate-300 hover:text-white transition-colors flex items-center gap-3">
                                <Users size={15} className="text-purple-400" /> Ver Clientes
                            </a>
                            <a href="/business/agenda" className="w-full p-3 bg-white/5 hover:bg-white/10 rounded-lg text-left text-sm text-slate-300 hover:text-white transition-colors flex items-center gap-3">
                                <CalendarCheck size={15} className="text-cyan-400" /> Ir a Agenda
                            </a>
                        </div>
                    </GlassPanel>
                </div>
