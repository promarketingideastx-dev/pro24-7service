        ...
        <div className="space-y-6">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-[#1e5555] border border-white/10 w-full max-w-md rounded-2xl p-6 shadow-2xl relative max-h-[90vh] overflow-y-auto custom-scrollbar">
                        <button
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-[#154040] border border-white/10 rounded-lg px-4 py-3 text-white focus:border-brand-neon-cyan focus:outline-none"
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full bg-[#154040] border border-white/10 rounded-lg px-4 py-3 text-white focus:border-brand-neon-cyan focus:outline-none appearance-none"
                                >
                            ...
                            <div>
                                ...
                                <div className="bg-[#154040] border border-white/10 rounded-lg p-2 max-h-40 overflow-y-auto custom-scrollbar space-y-1">
                                    {services.length === 0 ? (
            ...
            {/* Delete Confirmation Modal */}
            {
                memberToDelete && (
                    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
                        <div className="bg-[#1e5555] border border-white/10 w-full max-w-sm rounded-2xl p-6 shadow-2xl relative">
