                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full h-12 bg-[#1e5555] border border-white/10 rounded-lg px-4 text-white focus:outline-none focus:border-brand-neon-cyan"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full h-24 bg-[#1e5555] border border-white/10 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-brand-neon-cyan resize-none"
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div className="w-full h-12 bg-[#1e5555]/50 border border-white/5 rounded-lg px-4 flex items-center text-slate-400 cursor-not-allowed">
                                ...
                                return (
                                    <input
                                        ...
                                        className={`w-full h-12 rounded-lg px-4 focus:outline-none transition-colors
                                            ${hasPredefinedCities
                                                ? 'bg-[#1e5555]/50 border border-white/5 text-slate-400 cursor-not-allowed'
                                                : 'bg-[#1e5555] border border-white/10 text-white focus:border-brand-neon-cyan'
                                            }
                                        `}
                                    ...
                                    <button
                                        ...
                                        className={`h-10 rounded border text-sm font-medium transition-colors
                                            ${formData.modality === m
                                                ...
                                                : 'bg-[#1e5555] border-white/10 text-slate-400 hover:border-white/30'
                                            }
                                        `}
                                    >
                                            ...
                                            className={`
                                                ...
                                                ${isPrimary
                                                    ...
                                                    : isAdditional
                                                        ...
                                                        : 'bg-[#1e5555] border-white/5 text-slate-400 hover:border-white/20 hover:bg-[#1a233b]'
                                                }
                                            `}
                                        >
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`
                                                    ...
                                                    ${isSelected
                                                        ? 'bg-brand-neon-cyan/20 border-brand-neon-cyan text-white'
                                                        : 'bg-[#1e5555]/50 border-white/5 text-slate-400 hover:border-white/20 hover:text-slate-200'
                                                    }
                                                `}
                                            >
                        ...
                        {formData.subcategory && (
                            <div className="animate-in fade-in slide-in-from-top-4 duration-300">
                                ...
                                {(() => {
                                    ...
                                    return (
                                        <div className="bg-[#1e5555]/30 border border-white/5 rounded-xl p-4">
            ...
            case 5:
                ...
                return (
                    <div className="space-y-4 text-sm">
                        <div className="bg-[#1e5555]/50 p-4 rounded-lg border border-white/5">
