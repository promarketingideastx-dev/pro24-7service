...
function LoginForm() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (err.code === 'auth/invalid-credential' || err.code === 'auth/user-not-found' || err.code === 'auth/wrong-password') {
                ...
                setError('Demasiados intentos falidos. Intenta más tarde.');
            } else {
    ...
    return (
        <div className="bg-[#1e5555]/80 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl">
            <h2 className="text-xl font-bold text-white mb-2">Bienvenido de nuevo 👋</h2>
            <p className="text-slate-400 text-sm mb-6">Ingresa tus datos para continuar.</p>
                ...
                <div className="space-y-1">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full bg-[#154040] border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white placeholder:text-slate-600 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/50 transition-all"
                ...
                <div className="space-y-1">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full bg-[#154040] border border-white/10 rounded-xl py-3 pl-10 pr-10 text-white placeholder:text-slate-600 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/50 transition-all"
                            placeholder="••••••••"
                        />
                        <button
                            type="button"
            ...
            <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-[#1e5555] px-2 text-slate-500">O continúa con</span>
                </div>
            </div>
