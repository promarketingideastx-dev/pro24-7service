    ...
    return (
        <div className="bg-[#1e3a5f]/80 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl">
            ...
            <form onSubmit={handleRegister} className="space-y-4">
                <div className="space-y-1">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className={`w-full bg-[#1a2f4e] border rounded-xl py-3 pl-10 pr-4 text-white placeholder:text-slate-600 focus:outline-none transition-all
                ...
                <div className="space-y-1">
                    <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Confirmar Contraseña</label>
                    <div className="relative">
                        <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-500" />
                        <input
