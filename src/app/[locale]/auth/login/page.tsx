            ...
            if (err.code === 'auth/invalid-credential' || err.code === 'auth/wrong-password' || err.code === 'auth/user-not-found') {
                try {
                    ...
                    if (!reg) {
                        ...
                        setError('La contraseña proporcionada es incorrecta. Por favor, intenta nuevamente.');
                    }
                } catch (fallbackErr) {
                    setError('Correo electrónico no encontrado o contraseña incorrecta.');
                }
            } else if (err.code === 'auth/too-many-requests') {
                setError('Has excedido el número máximo de intentos. Por seguridad, tu cuenta ha sido bloqueada temporalmente. Restablece tu contraseña o intenta más tarde.');
            } else {
