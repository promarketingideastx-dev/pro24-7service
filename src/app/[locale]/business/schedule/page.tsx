...
export default function SchedulePage() {
    return (
        <div className="space-y-6">
            <div>
                <h1 className="text-2xl font-bold text-slate-900">Horario y Disponibilidad</h1>
            ...
            <GlassPanel className="p-12 flex flex-col items-center justify-center min-h-[400px] text-center">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">Agenda de Trabajo</h3>
                <p className="text-slate-400 max-w-md mb-6">
                    Aquí configurarás tus días laborales, horas de apertura/cierre y días libres.
                </p>
                <div className="px-4 py-2 bg-yellow-50 border border-yellow-200 rounded-lg text-yellow-700 text-xs font-mono">
