                        ...
                        <div className="flex flex-col items-center text-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-slate-400 text-sm leading-relaxed">
                                    {t('deleteModalDesc1')}<span className="text-red-400 font-bold">{t('deleteModalDescBold')}</span>{t('deleteModalDesc2')}
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col gap-3 w-full mt-4">
                                ...
                                >
                                    {isDeleting ? (
                                        <><div className="w-4 h-4 border-2 border-slate-300 border-t-white rounded-full animate-spin" /> {t('deletingAccount')}</>
                                    ) : (
                                        <><Trash2 size={18} /> {t('deleteModalConfirm')}</>
                                    )}
                                </button>
                                <button
                ...
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white border border-orange-500/20 w-full max-w-sm rounded-3xl p-6 shadow-2xl relative ring-1 ring-orange-500/20">
                        <div className="flex flex-col items-center text-center gap-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-slate-900 mb-2">{t('closeBizModalTitle')}</h3>
                                <p className="text-slate-500 text-sm leading-relaxed">
                                    {t('closeBizModalDesc1')} 
                                    <br/><br/>
                                    <strong>{t('closeBizModalDescBold')}</strong>{t('closeBizModalDesc2')}
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col gap-3 w-full mt-4">
                                ...
                                >
                                    {isClosingBiz ? (
                                        <><div className="w-4 h-4 border-2 border-slate-300 border-t-white rounded-full animate-spin" /> {t('processing')}</>
                                    ) : (
                                        <><Store size={18} /> {t('closeBizModalConfirm')}</>
                                    )}
                                </button>
                                <button
