            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-[#0a1128] border border-slate-200 rounded-2xl p-8 prose prose-invert max-w-none">
                    <div className="space-y-6 text-sm text-slate-300 leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-white font-bold text-base mb-2">1. Aceptación de Términos</h2>
                        ...
                        <section>
                            <h2 className="text-white font-bold text-base mb-2">4. Negocios y Proveedores</h2>
                        ...
                        <section>
                            <h2 className="text-white font-bold text-base mb-2">5. Pagos y Suscripciones</h2>
                        ...
                        <section>
                            <h2 className="text-white font-bold text-base mb-2">8. Ley Aplicable</h2>
                        ...
                        <section>
                            <h2 className="text-white font-bold text-base mb-2">9. Modificaciones</h2>
                        ...
                        <section>
                            <h2 className="text-white font-bold text-base mb-2">10. Contacto</h2>
