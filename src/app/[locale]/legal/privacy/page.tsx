        ...
        <div className="min-h-screen bg-[#F0F2F5] py-16 px-4">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-[#0a1128] border border-slate-200 rounded-2xl p-8 space-y-6 text-sm text-slate-300 leading-relaxed">
                    <section>
                        <h2 className="text-white font-bold text-base mb-2">1. Datos que recopilamos</h2>
                    ...
                    <section>
                        <h2 className="text-white font-bold text-base mb-2">2. Cómo usamos tus datos</h2>
                    ...
                    <section>
                        <h2 className="text-white font-bold text-base mb-2">3. Datos de ubicación</h2>
                    ...
                    <section>
                        <h2 className="text-white font-bold text-base mb-2">4. Retención de datos</h2>
                    ...
                    <section>
                        <h2 className="text-white font-bold text-base mb-2">5. Tus derechos</h2>
