...
export default function OnboardingPage() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-[#0f0d1a] p-6 relative overflow-hidden">
            {/* Background Effects */}
            ...
            <div className="relative z-10 w-full max-w-2xl flex flex-col items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="flex flex-col items-center p-8 bg-[#1a1030]/60 backdrop-blur-md border border-white/10 rounded-3xl hover:border-brand-neon-cyan hover:bg-[#1a1030]/80 hover:shadow-[0_0_30px_rgba(0,240,255,0.15)] transition-all group text-left relative overflow-hidden"
                    >
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="flex flex-col items-center p-8 bg-[#1a1030]/60 backdrop-blur-md border border-white/10 rounded-3xl hover:border-green-400 hover:bg-[#1a1030]/80 hover:shadow-[0_0_30px_rgba(74,222,128,0.15)] transition-all group text-left relative overflow-hidden"
                    >
