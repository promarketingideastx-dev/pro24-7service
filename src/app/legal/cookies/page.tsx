        ...
        <div className="min-h-screen bg-[#060d1f] py-16 px-4">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-[#0a1128] border border-white/5 rounded-2xl p-8 space-y-6 text-sm text-slate-300 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-white font-bold text-base mb-3">Tipos de cookies que usamos</h2>
                    ...
                    <section>
                        <h2 className="text-white font-bold text-base mb-2">Gestión de cookies</h2>
                    ...
                    <section>
                        <h2 className="text-white font-bold text-base mb-2">Marco legal</h2>
